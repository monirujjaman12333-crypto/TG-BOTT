...
COUNTRY_CODE_NAME = {
    ...
    "221": "🇸🇳 Senegal", "972": "🇮🇱 Israel", "263": "🇿🇼 Zimbabwe",
}
...
# =======================
# Init - mark existing as seen (MongoDB)
# =======================
def init_seen():
    seen = db.load_seen()
    data = fetch_hadi()
    if data and data.get("status") != "error":
        ...
        db.save_seen(seen)
        print(f"✅ Initialized with {len(seen)} existing OTPs (MongoDB)")
    return seen
